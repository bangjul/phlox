...
from flask import Flask, render_template, request, url_for, redirect, send_from_directory, Response, jsonify, json
...
app.config['UPLOADED_PHOTOS_DEST'] = 'static/public/images/test/'
...
def upload(name="upload"):
	if request.method == 'POST':
		...
		img = open('static/public/images/test/resize.png', 'rb')
		f = img.read()
		dataOri = base64.b64encode(f)
		dataOri = dataOri.decode('utf-8')

		img2 = open('static/public/images/test/hasil.png', 'rb')
		f2 = img2.read()
